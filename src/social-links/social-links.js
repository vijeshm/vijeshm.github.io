        ...
        <div className={`social-links-container ${mode}`}>
          <div className="social-links">
            ...
            <div className="social-link instagram">
              <a
                href="https://www.instagram.com/mv.vijesh/"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <div className="social-link twitter">
              <a
                href="https://twitter.com/edbidangi"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <div className="social-link linkedin">
              <a
                href="https://www.linkedin.com/in/vijesh-m-78068348/"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <div className="social-link email">
              <a href="mailto:mv.vijesh@gmail.com">
                <svg
                  width="24"
                  height="24"
                  xmlns="http://www.w3.org/2000/svg"
